...
def kmeans(learned_filter, n_clusters, n_init = 10):
    ...
    """returns labels, centers and assignment of the centers.
       greater time complexity than kmeansalter"""
...
def averaged_acc(list_of_interim_acc, no_of_clustering_kernels):
    return (list_of_interim_acc[np.argsort(list_of_interim_acc)[-no_of_clustering_kernels:]])
